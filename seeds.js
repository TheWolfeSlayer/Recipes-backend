...
mongoose
    ...
    const seedRecipes = [{
        ...
        steps: ["Brown the ground beef in a large skillet. (drain excess fat)", "Once cooked, throw in salt, pepper, tomato sauce and paste, water (with the bouillon cubes in it), sugar, basil, oregano, and garlic. Simmer on low for an hour.",  "A few minutes before the hour is done, cook box of spaghetti noodles as directed on package.",  "Once the noodles are cooked, drain and add to spaghetti sauce."],
        ...
        steps: ["Add the butter and cream to a large skillet.", "Simmer over low heat for 2 minutes.", "Whisk in the garlic, Italian seasoning, salt, and pepper for one minute.", "Whisk in the parmesan cheese until melted.", "Serve immediately."],
        ...
        steps: ["Preheat oven to 425° and line a large baking sheet with parchment paper. You can use a pizza stone instead if you have one.",  "Roll the pizza dough out into a circle or rectangle, then carefully transfer it to your lined baking sheet/pizza stone.", "Next, heat 1 tablespoon of olive oil in a large skillet, then add the spinach and garlic and sauté until spinach is wilted, about 2 minutes; transfer to a large bowl.",  "To that same bowl, add the ricotta and stir to combine.", "Drizzle the remaining oil over the pizza dough, then sprinkle the oregano and red pepper flakes on top. Spread the ricotta mixture over the pizza dough, then add the shredded mozzarella.", "Bake the pizza for 10-12 minutes or until the cheese is melted. Add more red pepper flakes to taste. Slice and enjoy!"],
        ...
        steps: ["Preheat oven to 350ºF.", "In a large bowl, combine cooked shredded chicken with 1/4 cup enchilada sauce.  Season with salt and pepper to taste.",  "Warm the tortillas in a microwave for 1 minute, flipping the them halfway through until they're warm and pliable.", "Assemble the enchiladas by filling each tortilla evenly with the shredded chicken mixture and a generous pinch of shredded cheese. Roll them tightly to close and place in a large baking dish seam side down.", "Pour the remaining enchilada sauce over the tortillas and then top them with the remaining cheese.",  "Bake for 20 minutes, until cheese is melted and bubbly. Serve."],
        ...
        steps: ["Set 3 cups of water to boil. Place olive oil in a large skillet that can be covered, and turn heat to medium-high. Add onions and a sprinkling of salt and pepper.",  "Cook, stirring occasionally, until onions soften and become translucent, 5 to 10 minutes. Remove skin from chicken.",  "Add rice to onions; stir until each grain glistens; sprinkle with saffron, and stir. Nestle chicken in rice, add a little more salt and pepper and pour in the boiling water. Turn heat to medium-low, and cover.",  "Cook 20 minutes, until all water is absorbed and chicken is cooked through. (You can keep this warm over a very low flame for another 15 minutes; it will retain its heat for 15 minutes beyond that.) Garnish and serve with lemon or lime."],
        ...
        steps: ["Salt and Pepper both sides of steak and set aside to come to room temperature. Heat a large heavy pan or cast iron skillet to medium high heat and add 1 tablespoon olive oil. Sear steaks for approximately 4 minutes on each side for medium rare steak. Remove and set aside to rest.",  "In a large bowl combine lettuce, arugula, radishes, tomatoes, cucumbers, and red onion. Mix well. In a small bowl, whisk together olive oil, vinegar, salt, pepper, and Italian seasoning. Drizzle oil and vinegar mixture over salad mixture toss until well-coated.",  "Slice steak against the grain into 1/4 thick strips. Place on top of salad and sprinkle with blue cheese crumbles. Serve with crusty bread and enjoy your healthy dinner."],
